...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'Swagger-Codegen/1.0.0/1.0.0-rc1/php/' . PHP_VERSION;
    ...
    {
        $report  = 'PHP SDK (DocuSign\Maestro) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.0.0' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.0-rc1' . PHP_EOL;
