...
use DocuSign\Maestro\Client\Auth\OAuth;
...
class ApiClient
{
    ...
    public function generateAccessToken($client_id = null, $client_secret = null, $code = null)
    {
        ...
        return [$this->getSerializer()->deserialize($response, '\DocuSign\Maestro\Client\Auth\OAuthToken', $httpHeader), $statusCode, $httpHeader];
    }
    ...
    public function getUserInfo($access_token)
    {
        ...
        return [
            $this->getSerializer()->deserialize(
                $response,
                '\DocuSign\Maestro\Client\Auth\UserInfo',
                $httpHeader
            ),
            $statusCode,
            $httpHeader
